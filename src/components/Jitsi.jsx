...
export default function Jitsi() {
    ...
    const options = {
        ...
        externalConnectUrl: 'https://8x8.vc/http-pre-bind', 
        enableP2P: true, 
        p2p: { 
           enabled: true, 
           preferH264: true, 
        ...
        useStunTurn: true, 
        bosh: `https://8x8.vc/http-bind?room=SampleAppColdBedsProbeImmensely`, 
...
useEffect(() => {
    ...
    connection.current = new window.JitsiMeetJS.JitsiConnection('vpaas-magic-cookie-345169c65de04bbaa541127da3329e78', null, options);
